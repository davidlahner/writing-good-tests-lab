...
public class AwkwardDependency {
	...
	public Duration getDurationOfAllMessagesFor(int userId) {
		User user = UserRepository.getUser(userId); // a user repository is an awfully complex object!
		List<Call> calls = Voicemail.getCallsFor(user); // a voicemail is an awfully complex object!
